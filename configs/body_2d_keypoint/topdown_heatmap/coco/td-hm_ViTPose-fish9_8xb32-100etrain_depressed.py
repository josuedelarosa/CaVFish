...
metainfo = dict(
    dataset_name='fish_19kpt_depressed',
    paper_info={},
    keypoint_info={
        ...
        13: dict(name='kp15', id=13, color=[255, 0, 0], type='lower', swap=''),
        14: dict(name='kp16', id=14, color=[255, 0, 0], type='lower', swap=''),
        15: dict(name='kp17', id=15, color=[255, 0, 0], type='lower', swap=''),
        16: dict(name='kp18', id=16, color=[255, 0, 0], type='upper', swap=''),
        17: dict(name='kp19', id=17, color=[255, 0, 0], type='upper', swap=''),
        18: dict(name='kp20', id=18, color=[255, 0, 0], type='lower', swap=''),
    },
    skeleton_info={},
    ...
    flip_pairs=[],
    num_keypoints=19,
    upper_body_ids=[0, 1, 2, 5, 7, 9, 11, 12, 16, 17],  
    lower_body_ids=[3, 4, 6, 8, 10, 13, 14, 15, 18]
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='depressed_body_19kpt_train.json',
...
############ WORKING DIR
work_dir = '/data/Pupils/Josue/weights/Fish/ViTPose_20kpt_depressed_300epochs'