...
custom_imports = dict(
    imports=[
        ...
        'phenolosses.vitpose_head_norm',
        'phenolosses.coord_smooth_l1_loss',
...
model = dict(
    ...
    head = dict(
        ...
        loss_coord=dict(type='CoordSmoothL1Loss', beta=0.5, reduction='none'),
        alpha_coord=1e-2,
        beta_softarg=10.0
    ),
    test_cfg=dict(
...
############ WORKING DIR
work_dir = '/data/Pupils/Josue/weights/Fish/ViTPose_20kpt_LossNorm1e-2'